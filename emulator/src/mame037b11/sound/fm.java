 ...
 /* !!!!!!!!!! pending !!!!!!!!!! */
    ...
    public static StreamInitMultiPtr YM2608UpdateOne = new StreamInitMultiPtr() {
        public void handler(int num, ShortPtr[] buffer, int length) {
            ...
            /*TODO*///YM_DELTAT DELTAT = FM2608[num].deltaT;
            int i, j;
            int ch;
            ShortPtr bufL;
            ShortPtr bufR;
            ...
            /*TODO*///DELTAT.arrivedFlag = 0;
            /* ASG */
            /*TODO*///DELTAT.flagMask = 1;
            /* ASG */
 /* buffer setup */
            bufL = buffer[0];
            bufR = buffer[1];
...
/*TODO*///#endif
            ...
            /*TODO*///if (DELTAT.arrivedFlag != 0) {
            /*TODO*///    FM_STATUS_SET(State, 0x04);
                /* ASG */
            /*TODO*///}
            /*TODO*///#if FM_LFO_SUPPORT
...
/*TODO*///#endif
 ...
 /* FM2608[i].OPN.ST.status = 0; */
            ...
            /* DELTA-T */
            /*TODO*///FM2608[i].deltaT = new YM_DELTAT();
                ...
                switch (addr & 0xf0) {
                    case 0x00:
                        ...
                        switch (addr) {
                            ...
                            default:
                                /* 0x00-0x0b */
                                /*TODO*///YM_DELTAT_ADPCM_Write(F2608.deltaT, addr, v & 0xFF);
                        }
                        break;
                    case 0x10:
                        /* IRQ Flag controll */
...
/*TODO*///
 ...
 /* FM2610[i].OPN.ST.status = 0; */
            ...
            /* DELTA-T */
            /*TODO*///FM2610[i].deltaT = new YM_DELTAT();
            /*TODO*///FM2610[i].deltaT.memory = pcmromb[i];
 ...
 /* A0-A5 = ADPCM-A          arrived end address */
                /*TODO*///ret = F2610.u8_adpcm_arrivedEndAddress | F2610.deltaT.arrivedFlag;
                break;
            case 3:
                ret = 0;
                break;

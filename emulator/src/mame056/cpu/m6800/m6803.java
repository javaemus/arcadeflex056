...
//logerror("CPU #%d PC %04x: warning - read TCSR register\n",cpu_getactivecpu(),cpu_get_pc());
                ...
                case 0x09:
                    if ((m6800.pending_tcsr & TCSR_TOF) == 0) {
                        m6800.tcsr = (m6800.tcsr & ~TCSR_TOF) & 0xFF;
                        MODIFIED_tcsr();
                    }
                    return (int) ((m6800.output_compare.L >> 8) & 0xFF);
                case 0x0a:
                    return (int) (m6800.output_compare.L & 0xFF);
                case 0x0b:
                    if ((m6800.pending_tcsr & TCSR_OCF) == 0) {
                        m6800.tcsr = (m6800.tcsr & ~TCSR_OCF) & 0xFF;
                        MODIFIED_tcsr();
                    }
                    return (int) ((m6800.output_compare.L >> 8) & 0xFF);
                case 0x0c:
                ...
                case 0x0d:
                    if ((m6800.pending_tcsr & TCSR_ICF) == 0) {
                        m6800.tcsr = (m6800.tcsr & ~TCSR_ICF) & 0xFF;
                        MODIFIED_tcsr();
                    }

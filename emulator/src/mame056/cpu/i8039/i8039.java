...
public class i8039 extends cpu_interface {
    ...
    public static void M_CALL(int addr) {
        push(R.PC & 0xFF);
        push((((R.PC >> 8) & 0xFF) & 0x0f) | (R.u8_PSW & 0xf0));
        R.PC = addr & 0xFFFF;
    ...
    static opcode anl_p1_n = new opcode() {
        public void handler() {
            R.u8_P1 = (char) ((R.u8_P1 & M_RDMEM_OPCODE()) & 0xFF);
            port_w(1, R.u8_P1);
        }
    };
    static opcode anl_p2_n = new opcode() {
        public void handler() {
            R.u8_P2 = (char) ((R.u8_P2 & M_RDMEM_OPCODE()) & 0xFF);
            port_w(2, R.u8_P2);
        }
    };
    ...
    static opcode in_a_p1 = new opcode() {
        public void handler() {
            R.u8_A = (char) ((port_r(1) & R.u8_P1) & 0xFF);
        }
    };
    static opcode in_a_p2 = new opcode() {
        public void handler() {
            R.u8_A = (char) ((port_r(2) & R.u8_P2) & 0xFF);
        }
    };
    ...
    static opcode jmp_1 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x100 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_2 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x200 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_3 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x300 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_4 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x400 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_5 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x500 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_6 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x600 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmp_7 = new opcode() {
        public void handler() {
            char/*UINT8*/ i = M_RDOP(R.PC);
            R.PC = (i | 0x700 | R.A11) & 0xFFFF;
        }
    };
    static opcode jmpp_xa = new opcode() {
        public void handler() {
            char addr = (char) ((R.PC & 0xf00) | R.u8_A);
            R.PC = ((R.PC & 0xf00) | M_RDMEM(addr)) & 0xFFF;
        }
    };
    ...
    static opcode movp_a_xa = new opcode() {
        public void handler() {
            R.u8_A = M_RDMEM((R.PC & 0x0f00) | R.u8_A);
        }
    };
    ...
    static opcode outl_p1_a = new opcode() {
        public void handler() {
            port_w(1, R.u8_A);
            R.u8_P1 = (char) (R.u8_A & 0xFF);
        }
    };
    static opcode outl_p2_a = new opcode() {
        public void handler() {
            port_w(2, R.u8_A);
            R.u8_P2 = (char) (R.u8_A & 0xFF);
        }
    };

    static opcode ret = new opcode() {
        public void handler() {
            R.PC = (((pull() & 0x0f) << 8)) & 0xFFFF;
            R.PC = (R.PC | pull()) & 0xFFFF;
        }
    };
    static opcode retr = new opcode() {
        public void handler() {
            char/*UINT8*/ i = pull();
            R.PC = (((i & 0x0f) << 8) | pull()) & 0xFFFF;
...
//	R.A11 = R.A11ff;	/* NS990113 */
    ...
    public void reset(Object param) {
        ...
        R.u8_xirq_en = 0;
        /* NS990113 */
        R.u8_timerON = 1;/* Mario Bros. doesn't work without this */
        R.masterClock = 0;
    }
...
/*TODO*///
    ...
    public void set_context(Object reg) {
        R = (I8039_Regs) reg;
        R.regPtr = ((M_By()) ? 24 : 0);
        R.u8_SP = (char) (((R.u8_PSW << 1) & 0x0f) & 0xFF);
    }

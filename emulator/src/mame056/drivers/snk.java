...
public class snk
{
	...
	public static UBytePtr shared_ram=new UBytePtr(), io_ram=new UBytePtr(), shared_ram2=new UBytePtr();
	
	/*********************************************************************/
        
        /* input port configuration */
        
        public static final int SNK_INP0            = 0;
	public static final int SNK_INP1            = 1;
        public static final int SNK_UNUSED          = 2;
	public static final int SNK_INP2            = 3;
        public static final int SNK_INP3            = 4;
        public static final int SNK_INP4            = 5;
        public static final int SNK_ROT12_PLAYER1   = 6;
        public static final int SNK_ROT12_PLAYER2   = 7;
        public static final int SNK_INP5            = 8;
        public static final int SNK_ROT8_PLAYER1    = 9;
        public static final int SNK_ROT8_PLAYER2    = 10;
        public static final int SNK_INP9            = 11;
        public static final int SNK_INP10           = 12;
        public static final int SNK_INP6            = 13;
        public static final int SNK_INP7            = 14;
        public static final int SNK_INP8            = 15;
	
	static int hard_flags;
	
	public static int SNK_MAX_INPUT_PORTS = 12;
	
	static int[] SNK_INPUT_PORT_TYPE = {
		SNK_UNUSED,
		SNK_INP0,
	...
	*/
	...
	static int snk_rot8( int which ){
        ...
        static int[] old_joydir=new int[2];
        static int[] dial_select=new int[2];
	...
	*/
	...
	static int snk_input_port_r( int which ){
		switch( snk_io[which] ){
			...
			default:
			logerror("read from unmapped input port:%dn", which );
			break;
		}
		return 0;
	}
	...
	*/
	...
	public static void SNK_JOY1_PORT(){
		PORT_START();
	...
	public static void SNK_JOY2_PORT(){
		PORT_START();
	...
	public static void SNK_BUTTON_PORT (){
		PORT_START();  
	...
	public static void SNK_COINAGE(){ 
	...
	/*public static int[] SNK_INPUT_PORT_TYPE = {
		SNK_INP0,
		SNK_INP1,	SNK_UNUSED,
		SNK_INP2,	SNK_UNUSED,
		SNK_UNUSED,	SNK_UNUSED,
		SNK_UNUSED,	SNK_UNUSED,
		SNK_INP3,	SNK_UNUSED,
		SNK_INP4
        ...
        public static int[] athena_io = SNK_INPUT_PORT_TYPE;

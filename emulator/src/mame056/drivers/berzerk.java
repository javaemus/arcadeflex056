...
import static mame056.vidhrdw.berzerk.*;
...
public class berzerk
{
	...
	static nvramPtr berzerk_nvram_handler = new nvramPtr() {
	...
	public static void COINAGE(int CHUTE){
	...
	public static VhConvertColorPromPtr init_palette= new VhConvertColorPromPtr() {
            public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
                ...
                System.arraycopy(game_palette, 0, palette, 0, palette.length);
            }
        };
	...
	public static int  frenzy_init_machine  = 0;

 ...
 * Changelog
 * ---------
 * 21/04/2019 - added sbasketb driver (shadow)
 */
...
import static mame056.vidhrdw.sbasketb.*;
...
public class sbasketb {
    ...
    static RomLoadPtr rom_sbasketu = new RomLoadPtr() {
        public void handler() {
    ...
    public static InitDriverPtr init_sbasketb = new InitDriverPtr() {
        public void handler() {
            konami1_decode();
        }
    };

...
public class scobra
{
	...
	/*TODO*///void moonwar_vh_convert_color_prom (unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom);
	/*TODO*///void darkplnt_vh_convert_color_prom(unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom);
	/*TODO*///void rescue_vh_convert_color_prom  (unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom);
	/*TODO*///void minefld_vh_convert_color_prom (unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom);
	/*TODO*///void stratgyx_vh_convert_color_prom(unsigned char *palette, unsigned short *colortable,const unsigned char *color_prom);
	
	
	
	
	/*TODO*///READ_HANDLER ( galaxian_videoram_r );
	...
	public static ReadHandlerPtr scobra_soundram_r = new ReadHandlerPtr() {
            public int handler(int offset) {
                return scobra_soundram.read(offset & 0x03ff);
            }
        };
	
	
	public static WriteHandlerPtr scobra_soundram_w = new WriteHandlerPtr() {
            public void handler(int offset, int data) {
                scobra_soundram.write(offset & 0x03ff, data);
            }
        };

...
public class carnival
{
	...
	public static int CPU_MUSIC_ID            = 1;       /* music CPU id number */
	
	
	/* output port 0x01 definitions - sound effect drive outputs */
	public static int OUT_PORT_1_RIFLE_SHOT   = 0x01;
	public static int OUT_PORT_1_CLANG        = 0x02;
	public static int OUT_PORT_1_DUCK_1       = 0x04;
	public static int OUT_PORT_1_DUCK_2       = 0x08;
	public static int OUT_PORT_1_DUCK_3       = 0x10;
	public static int OUT_PORT_1_PIPE_HIT     = 0x20;
	public static int OUT_PORT_1_BONUS_1      = 0x40;
	public static int OUT_PORT_1_BONUS_2      = 0x80;
	
	
	/* output port 0x02 definitions - sound effect drive outputs */
	public static int OUT_PORT_2_BEAR         = 0x04;
	public static int OUT_PORT_2_MUSIC_T1     = 0x08;
	public static int OUT_PORT_2_MUSIC_RESET  = 0x10;
	public static int OUT_PORT_2_RANKING      = 0x20;
	
	
	/* music CPU port definitions */
	public static final int MUSIC_PORT2_PSG_BDIR    = 0x40;    /* bit 6 on P2 */
	public static final int MUSIC_PORT2_PSG_BC1     = 0x80;    /* bit 7 on P2 */
	...
	//enum
	//{
		public static int SND_BEAR          = 0;
		public static int SND_BONUS_1       = 1;
		public static int SND_BONUS_2       = 2;
		public static int SND_CLANG         = 3;
		public static int SND_DUCK_1        = 4;
		public static int SND_DUCK_2        = 5;
		public static int SND_DUCK_3        = 6;
		public static int SND_PIPE_HIT      = 7;
		public static int SND_RANKING       = 8;
		public static int SND_RIFLE_SHOT    = 9;
	//};

...
public class berzerk
{
	...
	public static int VOICE_PITCH_MODULATION;	/* remove this to disable voice pitch modulation */
	...
	public static int VOICE_VOLUME = 100;
	public static int SOUND_VOLUME = 80;
	public static int SOUND_CHANNEL = 1;    /* channel for sound effects */
	public static int VOICE_CHANNEL = 5;    /* special channel for voice sounds only */
	public static int DEATH_CHANNEL = 6;    /* special channel for fake death sound only */
	
	/* berzerk sound */
	public static int lastfreq = 0;
	public static int lastnoise = 0;
	public static int lastvoice = 0;
	...
	/*TODO*///#ifdef VOICE_PITCH_MODULATION
		...
		if ((offset==3) || (offset==5))
		{
			if (lastnoise==70)
			{
				...
				if (offset==5)
				{
					if (data==nextdata5)
					{
	/*TODO*///#ifdef FAKE_DEATH_SOUND
	/*TODO*///					deathsound = 1; /* trigger death sound */
	/*TODO*///#else

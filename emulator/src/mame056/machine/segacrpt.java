...
/*TODO*///}
    ...
    public static void wmatch_decode()
    {
    //{ 0x08,0x80,0x20,0xa8 }
    //{ 0x20,0x08,0x80,0xa8 }
    //{ 0x20,0x20,0x80,0x80 }
    ...
    public static void spatter_decode()
    {
            char xortable[][] =
            {
                    /*       opcode                   data                     address      */
    ...
    ******************************************************************************/
    ...
    public static void astrofl_decode()
    {
            /* note how the first lines are highly repetitive, while the */
            /* following ones get more and more unique. */
            ...
            for (A = 0x0000;A < 0x8000;A++)
            {
                    ...
                    /* decode the opcodes */
                    rom.write(A + diff, src ^ opcode_xortable[row][col]);
                    if (opcode_xortable[row][col] == 0xff) rom.write(A + diff, 0);
    ...
    public static void wboy2_decode()
    {
            /* note how the first lines are highly repetitive, while the */
            /* following ones get more and more unique. */
            char opcode_xortable[][] =

...
public class scramble {
    ...
    public static InitMachinePtr scramble_init_machine = new InitMachinePtr() {
        public void handler() {
 ...
 /* (e.g. Lost Tomb, Rescue) will not pass the startup test. */
    ...
    public static ReadHandlerPtr scrambls_input_port_2_r = new ReadHandlerPtr() {
 ...
 /* avoid protection */
    ...
    public static WriteHandlerPtr moonwar_port_select_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            moonwar_port_select = data & 0x10;
        }
    };

    public static ReadHandlerPtr moonwar_input_port_0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int sign;
            int delta;
    ...
    public static ReadHandlerPtr stratgyx_input_port_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (readinputport(2) & ~0x06) | ((readinputport(4) << 1) & 0x06);
        }
    };

    public static ReadHandlerPtr stratgyx_input_port_3_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr darkplnt_input_port_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr scramble_protection_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* nothing to do yet */
        }
    };
    ...
    public static ReadHandlerPtr scrambls_protection_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            logerror("%04x: read protection\n", cpu_get_pc());
    ...
    public static ReadHandlerPtr triplep_pip_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr triplep_pap_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr cavelon_banksw_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            cavelon_banksw();
    ...
    public static WriteHandlerPtr cavelon_banksw_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cavelon_banksw();
    ...
    public static InitDriverPtr init_scramble_ppi = new InitDriverPtr() {
        public void handler() {
            ppi8255_init(ppi8255_intf);
        }
    };

    public static InitDriverPtr init_scobra = new InitDriverPtr() {
        public void handler() {
    ...
    public static InitDriverPtr init_atlantis = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_theend = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_stratgyx = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_tazmani2 = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_amidar = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_ckongs = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_mariner = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
 ...
 /*install_mem_write_handler(0, 0x6803, 0x6803, MWA_NOP);*/
    ...
    public static InitDriverPtr init_cavelon = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
 ...
 /*TODO*///install_mem_read_handler(0, 0x0000, 0x3fff, MRA_BANK1);
    ...
    public static InitDriverPtr init_moonwar = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_darkplnt = new InitDriverPtr() {
        public void handler() {
            init_scramble_ppi.handler();
    ...
    public static InitDriverPtr init_billiard = new InitDriverPtr() {
        public void handler() {
            ...
            for (A = 0; A < 0x4000; A++) {
                ...
                if ((bits[0] ^ (bits[7] & (bits[3] == 0 ? 1 : 0))) != 0) {
                    xormask ^= 0x04;
                }
                if ((bits[3] ^ ((bits[0] == 0 ? 1 : 0) & bits[2])) != 0) {
                    xormask ^= 0x08;
                }
                if ((bits[5] ^ ((bits[4] == 0 ? 1 : 0) & bits[1])) != 0) {
                    xormask ^= 0x10;
                }
                if ((bits[6] ^ ((bits[2] == 0 ? 1 : 0) & (bits[5] == 0 ? 1 : 0))) != 0) {
                    xormask ^= 0x20;
                }
                if ((bits[1] ^ ((bits[6] == 0 ? 1 : 0) & (bits[4] == 0 ? 1 : 0))) != 0) {
                    xormask ^= 0x40;
                }
                if ((bits[7] ^ ((bits[1] == 0 ? 1 : 0) & bits[0])) != 0) {
                    xormask ^= 0x80;
                }

 ...
 * Changelog
 * ---------
 * 22/05/2019 - ported lsasquad driver to 0.56 (shadow) - sound not working
 */
...
import static WIP.mame056.machine.lsasquad.*;

import static mame056.sound._2203intf.*;
import static mame056.sound._2203intfH.*;

import static mame056.vidhrdw.generic.*;
import static WIP.mame056.vidhrdw.lsasquad.*;
...
public class lsasquad {
 ...
 /* support that so we use 2 YM2203 */
    ...
    public static InitDriverPtr init_common = new InitDriverPtr() {
        public void handler() {
            UBytePtr ROM = memory_region(REGION_CPU1);

...
import static WIP.mame056.vidhrdw.speedbal.*;
...
public class speedbal
{
	...
	public static Memory_ReadAddress readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0xdbff, MRA_ROM ),
	...
	public static Memory_WriteAddress writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_WriteAddress( 0x0000, 0xdbff, MWA_ROM ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_speedbal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1, ROMREGION_DISPOSE );	ROM_LOAD("sb10.bin",  0x00000, 0x08000, 0x36dea4bf );   /* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2, ROMREGION_DISPOSE );	ROM_LOAD( "sb9.bin",  0x00000, 0x08000, 0xb567e85e );   /* bg tiles */
		...
		ROM_REGION( 0x10000, REGION_GFX3, ROMREGION_DISPOSE );	ROM_LOAD( "sb6.bin",  0x00000, 0x08000, 0x0e2506eb );   /* sprites */
	...
	public static InitDriverPtr init_speedbal = new InitDriverPtr() { public void handler()
	{
		...
		for (i = 0; i < memory_region_length(REGION_GFX3); i++)
			memory_region(REGION_GFX3).write(i, (memory_region(REGION_GFX3).read())^ 0xff);
	} };

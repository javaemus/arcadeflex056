...
public class balsente
{
	...
	public static final int LOG_CEM_WRITES = 0;
	
	
	/* global data */
	public static int balsente_shooter;
	public static int balsente_shooter_x;
	public static int balsente_shooter_y;
	...
	static int counter_control;
	static int counter_0_ff;
	static timer_entry counter_0_timer;
	...
	static int adc_shift;
	
	/* CEM3394 DAC control states */
	static long dac_value;
	static int dac_register;
	static int chip_select;
	
	/* main CPU 6850 states */
	static int m6850_status;
	static int m6850_control;
	static int m6850_input;
	static int m6850_output;
	static int m6850_data_ready;
	
	/* sound CPU 6850 states */
	static int m6850_sound_status;
	static int m6850_sound_control;
	static int m6850_sound_input;
	static int m6850_sound_output;
	
	/* noise generator states */
	static int[] noise_position = new int[6];
	
	/* game-specific states */
	static int nstocker_bits;
	static int spiker_expand_color;
	static int spiker_expand_bgcolor;
	static int spiker_expand_bits;
	...
	public static InitMachinePtr init_machine = new InitMachinePtr() { public void handler()
	{
		...
		//memset(counter, 0, sizeof(counter) );
                counter = new counter_state[3];
                
                for (int _i=0 ; _i<3 ; _i++)
                    counter[_i]=new counter_state();
	...
	static void noise_gen(int chip, int count, UBytePtr buffer)
	{
		...
		if (Machine.sample_rate != 0)
		{
			...
			long step = (100000 << 14) / Machine.sample_rate;
			long noise_counter = noise_position[chip];
	...
	static void m6850_update_io()
	{
		...
		new_state = 0;
		if ((m6850_control & 0x80)!=0 && (m6850_status & 0x21)!=0 ) new_state = 1;
		if ((m6850_control & 0x60) == 0x20 && (m6850_status & 0x02)!=0 ) new_state = 1;
	
		/* apply the change */
		if (new_state!=0 && (m6850_status & 0x80)==0 )
		{
			cpu_set_irq_line(0, M6809_FIRQ_LINE, ASSERT_LINE);
			m6850_status |= 0x80;
		}
		else if ((new_state==0) && (m6850_status & 0x80)!=0 )
		{
		...
		new_state = 0;
		if ((m6850_sound_control & 0x80)!=0 && (m6850_sound_status & 0x21)!=0 ) new_state = 1;
		if ((m6850_sound_control & 0x60) == 0x20 && (m6850_sound_status & 0x02)!=0 ) new_state = 1;
		if ((counter_control & 0x20) == 0 ) new_state = 0;
	
		/* apply the change */
		if (new_state!=0 && (m6850_sound_status & 0x80)==0 )
		{
			cpu_set_nmi_line(1, ASSERT_LINE);
			m6850_sound_status |= 0x80;
		}
		else if ((new_state==0) && (m6850_sound_status & 0x80)!= 0 )
		{
	...
	public static void counter_start(int which)
	{
		...
		if (which != 0)
		{
			...
			if (counter[which].gate!=0 && (counter[which].timer == null))
		...
		switch (offset & 3)
		{
			...
			case 2:
				...
				if (counter[which].readbyte == 0)
				{
					...
					return (int) (counter[which].count & 0xff);
				}
				...
				else
				{
					...
					return (int) ((counter[which].count >> 8) & 0xff);
				}
				//break;
		}
		return 0;
	...
	static void set_counter_0_ff(int newstate)
	{
		...
		if (counter_0_ff!=0 && (newstate==0))
		{
			/* only count if gated and non-zero */
			if (counter[0].count > 0 && (counter[0].gate!=0))
			{
				counter[0].count--;
	...
	public static ReadHandlerPtr counter_state_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		int result = counter_0_ff!=0?0:1;
	
		/* bit D1 is the OUT value from counter 0 */
		if (counter[0].out != 0) result |= 0x02;
	...
	{
		int diff_counter_control = counter_control ^ data;
		...
		if ((counter[0].gate==0) && ((data & 0x02)!=0) && (counter_0_timer==null))
		{
			update_counter_0_timer();
		}
	
		/* if we gate off, remove the timer */
		else if ((counter[0].gate!=0) && ((data & 0x02)==0) && (counter_0_timer!=null))
		{
			timer_remove(counter_0_timer);
			counter_0_timer = null;
		}
	...
	public static ReadHandlerPtr spiker_expand_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		left  = (spiker_expand_bits & 0x10)!=0 ? spiker_expand_color : spiker_expand_bgcolor;
		right = (spiker_expand_bits & 0x01)!=0 ? spiker_expand_color : spiker_expand_bgcolor;
	 ...
	 *
	 *************************************/
	public static int CEM3394_VCO_FREQUENCY     = 0;
        public static int CEM3394_FINAL_GAIN        = 1;
        public static int CEM3394_FILTER_RESONANCE  = 2;
        public static int CEM3394_FILTER_FREQENCY   = 3;
        public static int CEM3394_MIXER_BALANCE     = 4;
        public static int CEM3394_MODULATION_AMOUNT = 5;
	...
	/*TODO*///			{
	/*TODO*///				
	/*TODO*///				logerror("s%04X:   CEM#%d:%s=%fn", cpu_getpreviouspc(), i, names[dac_register], voltage);
	/*TODO*///			}
	//#endif
			}
	...
	public static Memory_ReadAddress readmem_cpu1[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),	new Memory_ReadAddress( 0x0000, 0x8fff, MRA_RAM ),
	...
	public static IO_ReadPort readport_cpu2[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_ReadPort( 0x00, 0x03, counter_8253_r ),
		new IO_ReadPort( 0x08, 0x0f, counter_state_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	
	public static IO_WritePort writeport_cpu2[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),	new IO_WritePort( 0x00, 0x03, counter_8253_w ),
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "Every 10,000" );	PORT_DIPSETTING(    0x01, "Every 15,000" );	PORT_DIPSETTING(    0x02, "Every 20,000" );	PORT_DIPSETTING(    0x03, "Every 25,000" );	PORT_DIPNAME( 0x0c, 0x04, DEF_STR( "Lives") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Display Kids" );	PORT_DIPSETTING(    0x02, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x04, 0x04, "Kid on Left Located" );	PORT_DIPSETTING(    0x04, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x08, 0x08, "Kid on Right Located" );	PORT_DIPSETTING(    0x08, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x01, 0x00, "Game Duration" );	PORT_DIPSETTING(    0x00, "11 points" );	PORT_DIPSETTING(    0x01, "15 points" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x01, 0x00, "Display Kids" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "Kid on Right Located" );	PORT_DIPSETTING(    0x02, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x04, 0x04, "Kid on Left Located" );	PORT_DIPSETTING(    0x04, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		...
		PORT_DIPNAME( 0x40, 0x00, "Bee In Game" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x80, 0x00, "Bug Generation" );	PORT_DIPSETTING(    0x00, "Regular" );	PORT_DIPSETTING(    0x80, "None" );
		PORT_START(); 	/* IN2 */
		...
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP    | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN  | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT  | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* "analog" ports */
		PORT_START(); 
		PORT_BIT( 0x1f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1, "Top-Right", KEYCODE_9_PAD, IP_JOY_DEFAULT );	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1, "Top",       KEYCODE_8_PAD, IP_JOY_DEFAULT );	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1, "Top-Left",  KEYCODE_7_PAD, IP_JOY_DEFAULT );
		PORT_START(); 
		PORT_BIT( 0x1f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1, "Right",     KEYCODE_6_PAD, IP_JOY_DEFAULT );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_BUTTON5 | IPF_PLAYER1, "Left",      KEYCODE_4_PAD, IP_JOY_DEFAULT );
		PORT_START(); 
		PORT_BIT( 0x1f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON6 | IPF_PLAYER1, "Bot-Right", KEYCODE_3_PAD, IP_JOY_DEFAULT );	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_BUTTON7 | IPF_PLAYER1, "Bottom",    KEYCODE_2_PAD, IP_JOY_DEFAULT );	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_BUTTON8 | IPF_PLAYER1, "Bot-Left",  KEYCODE_1_PAD, IP_JOY_DEFAULT );
		UNUSED_ANALOG();
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPNAME( 0x0c, 0x04, "Minimum Game Time" );	PORT_DIPSETTING(    0x08, "45" );	PORT_DIPSETTING(    0x04, "60" );	PORT_DIPSETTING(    0x00, "90" );	PORT_DIPSETTING(    0x0c, "120" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, "Keep High Scores" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
			...
			for (base = 0x10000; base < memory_region_length(REGION_CPU1); base += 0x30000)
			{
				...
				for (dest = 0x00000; dest < 0x20000; dest += 0x02000)
				{
					if ((cd_rom_mask & SWAP_HALVES) != 0)
						memcpy(new UBytePtr(temp, (int) (dest ^ 0x02000)), new UBytePtr(rom, (int) (base + dest)), 0x02000);
					else
						memcpy(new UBytePtr(temp, (int) dest), new UBytePtr(rom, (int) (base + dest)), 0x02000);
				}
	
				memcpy(new UBytePtr(rom, (int) (base + 0x2e000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x2c000)), cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x2a000)), new UBytePtr(ab_base,0xe000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x2800)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x26000)), cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x24000)), new UBytePtr(ab_base, 0xc000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x22000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x20000)), (cd_rom_mask & 0x20)!=0 ? new UBytePtr(cd_base, 0xa000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x1e000)), new UBytePtr(ab_base, 0xa000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x1c000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x1a000)), (cd_rom_mask & 0x10)!=0 ? new UBytePtr(cd_base, 0x8000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x18000)), new UBytePtr(ab_base, 0x8000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x16000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x14000)), (cd_rom_mask & 0x08)!=0 ? new UBytePtr(cd_base, 0x6000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x12000)), new UBytePtr(ab_base, 0x6000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x10000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x0e000)), (cd_rom_mask & 0x04)!=0 ? new UBytePtr(cd_base, 0x4000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x0c000)), new UBytePtr(ab_base, 0x4000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x0a000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x08000)), (cd_rom_mask & 0x02)!=0 ? new UBytePtr(cd_base, 0x2000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x06000)), new UBytePtr(ab_base, 0x2000), 0x2000);
	
				memcpy(new UBytePtr(rom, (int) (base + 0x04000)), ef_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x02000)), (cd_rom_mask & 0x01)!=0 ? new UBytePtr(cd_base, 0x0000) : cd_common, 0x2000);
				memcpy(new UBytePtr(rom, (int) (base + 0x00000)), new UBytePtr(ab_base, 0x0000), 0x2000);
			}
	...
	public static InitDriverPtr init_minigolf = new InitDriverPtr() { public void handler() { expand_roms(EXPAND_NONE); balsente_shooter = 0; adc_shift = 2; } };
	public static InitDriverPtr init_minigol2 = new InitDriverPtr() { public void handler() { expand_roms(0x0c);        balsente_shooter = 0; adc_shift = 2; } };
	...
	public static InitDriverPtr init_stompin = new InitDriverPtr() { public void handler()  { expand_roms(0x0c | SWAP_HALVES); balsente_shooter = 0; adc_shift = 32; } };
	...
	static RomLoadPtr rom_minigolf = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.u8a",  0x10000, 0x4000, 0x348f827f );	ROM_LOAD( "ab23.u7a",  0x14000, 0x4000, 0x19a6ff47 );	ROM_LOAD( "ab45.u6a",  0x18000, 0x4000, 0x925d76eb );	ROM_LOAD( "ab67.u5a",  0x1c000, 0x4000, 0x6a311c9a );	ROM_LOAD( "1a-ver2",   0x20000, 0x10000, 0x60b6cd58 );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1, 0 );	/* up to 64k of sprites */
	...
	static RomLoadPtr rom_stompin = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1, 0 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.bin",  0x10000, 0x4000, 0x46f428c6 );	ROM_LOAD( "ab23.bin",  0x14000, 0x4000, 0x0e13132f );	ROM_LOAD( "ab45.bin",  0x18000, 0x4000, 0x6ed26069 );	ROM_LOAD( "ab67.bin",  0x1c000, 0x4000, 0x7f63b516 );	ROM_LOAD( "cd23.bin",  0x24000, 0x4000, 0x52b29048 );	ROM_LOAD( "cd6ef.bin", 0x2c000, 0x4000, 0xb880961a );
		ROM_REGION( 0x10000, REGION_CPU2, 0 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1, 0 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.u4c", 0x00000, 0x4000, 0x14ffdd1e );	ROM_LOAD( "gr23.u3c", 0x04000, 0x4000, 0x761abb80 );	ROM_LOAD( "gr45.u2c", 0x08000, 0x4000, 0x0d2cf2e6 );	ROM_LOAD( "gr67.u2c", 0x0c000, 0x4000, 0x2bab2784 );ROM_END(); }}; 

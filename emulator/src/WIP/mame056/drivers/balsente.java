...
public class balsente {
 ...
 /* special case is offset 7, which recalls the NVRAM data */
    ...
    static void m6850_update_io() {
        ...
        new_state = 0;
        if ((m6850_control & 0x80) != 0 && (m6850_status & 0x21) != 0) {
            new_state = 1;
        }
        if ((m6850_control & 0x60) == 0x20 && (m6850_status & 0x02) != 0) {
            new_state = 1;
        }
        ...
        new_state = 0;
        if ((m6850_sound_control & 0x80) != 0 && (m6850_sound_status & 0x21) != 0) {
            new_state = 1;
        }
        if ((m6850_sound_control & 0x60) == 0x20 && (m6850_sound_status & 0x02) != 0) {
            new_state = 1;
        }
        if ((counter_control & 0x20) == 0) {
            new_state = 0;
        }
 ...
 /* if we gate on, start a pulsing timer to clock it */
            ...
            } /* if we gate off, remove the timer */ else if ((counter[0].gate != 0) && ((data & 0x02) == 0) && (counter_0_timer != null)) {
                timer_remove(counter_0_timer);
                counter_0_timer = null;
            }

...
import static WIP.mame056.vidhrdw.balsente.*;
...
public class balsente
{
 ...
 /*UINT32*/
	...
	static void m6850_update_io()
	{
		...
		new_state = 0;
		if ((u8_m6850_control & 0x80)!=0 && (u8_m6850_status & 0x21)!=0 ) new_state = 1;
		if ((u8_m6850_control & 0x60) == 0x20 && (u8_m6850_status & 0x02)!=0 ) new_state = 1;
		...
		new_state = 0;
		if ((u8_m6850_sound_control & 0x80)!=0 && (u8_m6850_sound_status & 0x21)!=0 ) new_state = 1;
		if ((u8_m6850_sound_control & 0x60) == 0x20 && (u8_m6850_sound_status & 0x02)!=0 ) new_state = 1;
		if ((u8_counter_control & 0x20)==0 ) new_state = 0;
	...
	public static ReadHandlerPtr counter_state_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (counter[0].u8_out!=0) result |= 0x02;
	...
	public static WriteHandlerPtr counter_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		else if (counter[0].u8_gate!=0 && (data & 0x02)==0 && counter_0_timer!=null)
		{
			timer_remove(counter_0_timer);
			counter_0_timer = null;
		}
		...
		if ((data & 0x04)==0 ) set_counter_0_ff(1);
		if ((data & 0x10)==0 ) set_counter_0_ff(0);
	...
	public static void  UNUSED_ANALOG_X4()
        {UNUSED_ANALOG_X2(); UNUSED_ANALOG_X2();
                }
	...
	INPUT_PORTS_END(); }}; 
        ...
        static InputPortPtr input_ports_triviag2 = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x02, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x03, DEF_STR( "1C_1C") );
	...
	static InputPortPtr input_ports_triviasp = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x02, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x03, DEF_STR( "1C_1C") );
	...
	INPUT_PORTS_END(); }}; 
        ...
        static InputPortPtr input_ports_triviayp = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x02, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x03, DEF_STR( "1C_1C") );
	...
	INPUT_PORTS_END(); }}; 
        ...
        static InputPortPtr input_ports_triviabb = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x02, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x03, DEF_STR( "1C_1C") );
 ...
 /* ROM region must be 0x40000 total */
	...
	public static InitDriverPtr init_gghost = new InitDriverPtr() { public void handler()    { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 1; } };
	...
	public static InitDriverPtr init_otwalls = new InitDriverPtr() { public void handler()   { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 0; } };
	public static InitDriverPtr init_snakepit = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 1; } };
	public static InitDriverPtr init_snakjack = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 1; } };
	public static InitDriverPtr init_stocker = new InitDriverPtr() { public void handler()   { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 0; } };
	...
	public static InitDriverPtr init_gimeabrk = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; u8_adc_shift = 1; } };
	public static InitDriverPtr init_minigolf = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_NONE); balsente_shooter = 0; u8_adc_shift = 2; } };
	public static InitDriverPtr init_minigol2 = new InitDriverPtr() { public void handler()  { expand_roms(0x0c);        balsente_shooter = 0; u8_adc_shift = 2; } };
	...
	public static InitDriverPtr init_nstocker = new InitDriverPtr() { public void handler() 
	{
		...
		expand_roms(EXPAND_NONE | SWAP_HALVES); balsente_shooter = 1; u8_adc_shift = 1;
	} };
	public static InitDriverPtr init_sfootbal = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL  | SWAP_HALVES); balsente_shooter = 0; u8_adc_shift = 0; } };
	public static InitDriverPtr init_spiker = new InitDriverPtr() { public void handler() 
	{
		...
		expand_roms(EXPAND_ALL  | SWAP_HALVES); balsente_shooter = 0; u8_adc_shift = 1;
	} };
	public static InitDriverPtr init_stompin = new InitDriverPtr() { public void handler()   { expand_roms(0x0c | SWAP_HALVES); balsente_shooter = 0; u8_adc_shift = 32; } };
